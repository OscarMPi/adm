  ...
  <div id="wrapper" class="d-flex align-items-center justify-content-center">
    <div class="auth-box register">
      <div class="content">
        ...
        <form class="form-auth-small" method="POST" action="" id="form-recover-pass">
         <?php
            $email = "";
         ...
         ?>
          ...
          <button type="submit" class="btn btn-primary btn-lg btn-block"  name="SendRecoverPass" value="Recuperar" >RESET PASSWORD</button>
          <div class="bottom">
