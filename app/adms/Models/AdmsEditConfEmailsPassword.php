...
class AdmsEditConfEmailsPassword
{
    ...
    public function viewConfEmailsPassword(int $id): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Senha da configuração de email não encontrada!</p>";
            $this->result = false;
        }
    }
    ...
    private function edit(): void
    {
        ...
        if ($upConfEmailsPass->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'> Senha da configuração de email não editada com sucesso!</p>";
            $this->result = false;
        }
    }
