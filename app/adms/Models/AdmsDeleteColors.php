...
class AdmsDeleteColors
{
    ...
    public function deleteColor(int $id): void
    {
        ...
        if (($this->viewColor()) and ($this->checkColorUsed())) {
            ...
            if ($deleteColor->getResult()) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Cor não apagada com sucesso!</p>";
                $this->result = false;
            }
        } else {
            $this->result = false;
    ...
    private function viewColor(): bool
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Cor não encontrada!</p>";
            return false;
        }
    }
    ...
    private function checkColorUsed(): bool
    {
        ...
        if ($viewColorUsed->getResult()) {
            $_SESSION['msg'] = "<p class='alert-danger'>Cor não pode ser apagada, há situação cadastrada com essa cor!</p>";
            return false;
        } else {
            return true;
        }
