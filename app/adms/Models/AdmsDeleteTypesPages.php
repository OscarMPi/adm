...
class AdmsDeleteTypesPages
{
    ...
    public function deleteTypesPages(int $id): void
    {
        ...
        if(($this->viewTypesPages()) and ($this->checkStatusUsed())){
            ...
            if ($deleteTypesPages->getResult()) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'> Tipo de página não apagado com sucesso!</p>";
                $this->result = false;
            }
        }else{
            $this->result = false;
    ...
    private function checkStatusUsed(): bool
    {
        ...
        if($viewPagesAdd->getResult()){
            $_SESSION['msg'] = "<p class='alert-warning'> Tipo de página não pode ser apagado, há páginas cadastradas com esse tipo!</p>";
            return false;
        }else{
            return true;
        }
