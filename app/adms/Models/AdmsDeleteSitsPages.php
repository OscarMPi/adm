...
class AdmsDeleteSitsPages
{
    ...
    private function viewSitPages(): bool
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Situação de página não encontrada!</p>";
            return false;
        }
    }
    ...
    private function checkStatusUsed(): bool
    {
        ...
        if($viewPagesAdd->getResult()){
            $_SESSION['msg'] = "<p class='alert-warning'>Situação não pode ser apagada, há páginas cadastradas com essa situação!</p>";
            return false;
        }else{
            return true;
        }
