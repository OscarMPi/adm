...
class AdmsEditPageMenu
{
    ...
    public function viewPageMenu(int $id): bool
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Página no item de menu não encontrado!</p>";
            $this->result = false;
            return false;
        }
    }
    ...
    public function update(array $data = null): void
    {
        ...
        if ($valEmptyField->getResult()) {
            if ($this->viewPageMenu($this->data['id'])) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Sem permissão para editar!</p>";
                $this->result = false;
            }
        } else {
            $this->result = false;
    ...
    private function edit(): void
    {
        ...
        if ($upColor->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'> Item de menu da página não editado com sucesso!</p>";
            $this->result = false;
        }
    }
