...
class AdmsRecoverPassword
{
    ...
    private function valUser(): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>E-mail não cadastrado!</p>";
            $this->result = false;
        }
    }
    ...
    private function valConfEmail(): void
    {
            ...
            if($upNewConfEmail->getResult()){
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Link não enviado, tente novamente!</p>";
                $this->result = false;
            }
    ...
    private function sendEmail(): void
    {
        ...
        if ($sendEmail->getResult()) {
            $_SESSION['msg'] = "<p class='alert-success'>Acesse ao E-mail para recuperar a Password!</p>";
            $this->result = true;
        } else {
            $this->fromEmail = $sendEmail->getFromEmail();
            $_SESSION['msg'] = "<p class='alert-danger'>E-mail não enviado, tente novamente ou contate-nos {$this->fromEmail}!</p>";
            $this->result = false;
        }
    }
