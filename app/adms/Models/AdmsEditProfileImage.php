...
class AdmsEditProfileImage
{
    ...
    /** @var array $data Recebe os dados que devem ser salvos no banco de dados */
    private array $data;
    
    /** @var array $dataImagem Recebe os dados da imagem */
    private array $dataImagem;
    
    /** @var string $nameImg Recebe o nome da imagem */
    private string $nameImg;
    
    /** @var string $directory Recebe o diretório onde será salvo a imagem */
    private string $directory;
    
    /** @var string $delImg Recebe o endereço da imagem a ser deletada */
    ...
    public function update(array $data = null): void
    {
        ...
        if ($valEmptyField->getResult()) {
            if (!empty($this->dataImagem['name'])) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Necessário selecionar uma imagem!</p>";
                $this->result = false;
            }
        } else {
            $this->result = false;
    ...
    private function edit(): void
    {
        ...
        if ($upUser->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'> Imagem não editada com sucesso!</p>";
            $this->result = false;
        }
    }
