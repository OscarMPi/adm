...
class AdmsEditConfEmails
{
    ...
    public function viewConfEmails(int $id): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'> Configuração de email não encontrada!</p>";
            $this->result = false;
        }
    }
    ...
    private function edit(): void
    {
        ...
        if ($upConfEmails->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'> Configuração de email não editada com sucesso!</p>";
            $this->result = false;
        }
    }
