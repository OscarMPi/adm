...
class AdmsAddAccessLevels
{
    ...
    private function add(): void
    {
        if ($this->viewLastAccessLevels()) {
            ...
            if ($createAccessLevels->getResult()) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Nível de acesso não cadastrado com sucesso!</p>";
                $this->result = false;
            }
        }
    }
    ...
    private function viewLastAccessLevels()
    {
        ...
        if ($this->resultadoBd) {
            ...
            $_SESSION['msg'] = "<div class='alert alert-danger' role='alert'>Nível de acesso não cadastrado com sucesso. Tente mais tarde!</div>";
            return false;
        }
    }
}
