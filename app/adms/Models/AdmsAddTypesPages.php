...
class AdmsAddTypesPages
{
    ...
    private function add(): void
    {
        if ($this->viewLastTypesPages()) {
            ...
            if ($createTypesPages->getResult()) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Tipo de página não cadastrado com sucesso!</p>";
                $this->result = false;
            }
        }
    }
    ...
    private function viewLastTypesPages()
    {
        ...
        if ($this->resultadoBd) {
            ...
            $_SESSION['msg'] = "<div class='alert alert-danger' role='alert'>Tipo de página não cadastrado com sucesso. Tente mais tarde!</div>";
            return false;
        }
    }
}
