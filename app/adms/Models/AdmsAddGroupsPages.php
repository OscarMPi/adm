...
class AdmsAddGroupsPages
{
    ...
    private function add(): void
    {
        if ($this->viewLastGroupsPages()) {
            ...
            if ($createGroupsPages->getResult()) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Grupo de página não cadastrado com sucesso!</p>";
                $this->result = false;
            }
        }
    }
    ...
    private function viewLastGroupsPages()
    {
        ...
        if ($this->resultadoBd) {
            ...
            $_SESSION['msg'] = "<div class='alert alert-danger' role='alert'>Grupo de página não cadastrado com sucesso. Tente mais tarde!</div>";
            return false;
        }
    }
}
