...
class AdmsUpdatePassword
{
    ...
    public function valKey(string $key): bool
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'> Link inválido, solicite novo link <a href='" . URLADM . "recover-password/index'>clique aqui</a>!</p>";
            $this->result = false;
            return false;
        }
    }
    ...
    private function updatePassword():void
    {
        ...
        if($upPassword->getResult()){
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Senha não atualizada, tente novamente!</p>";
            $this->result = false;
        }
    }
}
