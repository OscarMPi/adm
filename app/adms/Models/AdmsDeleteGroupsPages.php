...
class AdmsDeleteGroupsPages
{
    ...
    public function deleteGroupsPages(int $id): void
    {
        ...
        if(($this->viewGroupsPages()) and ($this->checkStatusUsed())){
            ...
            if ($deleteGroupsPages->getResult()) {
                ...
                $_SESSION['msg'] = "<p class='alert-danger'>Grupo de página não apagado com sucesso!</p>";
                $this->result = false;
            }
        }else{
            $this->result = false;
    ...
    private function checkStatusUsed(): bool
    {
        ...
        if($viewPagesAdd->getResult()){
            $_SESSION['msg'] = "<p class='alert-warning'> Grupo de página não pode ser apagado, há páginas cadastradas com esse grupo!</p>";
            return false;
        }else{
            return true;
        }
