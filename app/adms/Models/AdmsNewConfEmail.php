...
class AdmsNewConfEmail 
{
    ...
    private function sendEmail(): void
    {
        ...
        if ($sendEmail->getResult()) {
            $_SESSION['msg'] = "<p class='alert-success'>Sucesso. Acesse ao E-mail enviado!</p>";
            $this->result = true;
        } else {
            $this->fromEmail = $sendEmail->getFromEmail();
            $_SESSION['msg'] = "<p class='alert-danger'>Tente novamente ou entre em contato com o e-mail {$this->fromEmail}!</p>";
            $this->result = false;
        }
    }
